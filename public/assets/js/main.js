...
function makeInviteButton(socket_id) {
    let newHTML = "<button type='button' class='btn btn-outline-dark'>Invite</button>";
    let newNode = $(newHTML);
    newNode.click( () => {
        let payload = {
...
function makeInvitedButton(socket_id) {
    let newHTML = "<button type='button' class='btn btn-danger'>Invited</button>";
    let newNode = $(newHTML);
     newNode.click( () => {
        let payload = {
            requested_user: socket_id
...
socket.on('join_room_response', (payload) =>{
    ...
    /* Announcing chat some has arrive */
    let nodeA = $("<div></div>");
    nodeA.addClass("row");
...
socket.on('game_over', (payload) =>{
    ...
    let nodeD = $("<a href='lobby.html?username=" + username + "' class='btn btn-lg btn-danger' role='button'>Return to lobby</a>");
    nodeA.append(nodeB);
    nodeA.append(nodeC);
    nodeA.append(nodeD);
    nodeA.hide();
